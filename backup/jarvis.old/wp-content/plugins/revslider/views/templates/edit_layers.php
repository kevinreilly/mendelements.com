							...
							<div class="postbox unite-postbox">
								...
								<div class="toggled-content tp-closeifotheropen">
									<ul class="list_settings">
										...
										//$title = $c_slide["title"];
										?>
										<div id="layer_static_wrapper" style="<?php echo $show_static; ?>">
											<li style="clear:both;" id="layer_static_title_row">
												<span original-title="" class="setting_text_2 text-disabled"><?php _e('Static Options', REVSLIDER_TEXTDOMAIN); ?></span>
											</li>
											<li>
