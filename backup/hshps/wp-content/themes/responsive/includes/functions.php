...
function responsive_breadcrumb_lists() {
    ...
    function responsive_widgets_init() {
        ...
        register_sidebar(array(
            'name' => __('Rates Sidebar', 'responsive'),
            'description' => __('Area 2 - sidebar-rates.php', 'responsive'),
            'id' => 'rates-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
        ...
        register_sidebar(array(
            'name' => __('About Sidebar', 'responsive'),
            'description' => __('Area 2 - sidebar-about.php', 'responsive'),
            'id' => 'about-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
        ...
        register_sidebar(array(
            'name' => __('Contact Sidebar', 'responsive'),
            'description' => __('Area 2 - sidebar-contact.php', 'responsive'),
            'id' => 'contact-sidebar',
            'before_title' => '<div class="widget-title">',
            'after_title' => '</div>',
            'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
