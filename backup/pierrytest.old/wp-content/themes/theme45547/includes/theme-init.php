...
if ( ! function_exists( 'my_setup' ) ):
	function my_setup() {
		...
		if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
			...
			add_image_size( 'slider-post-thumbnail', 1600, 645, true ); // Slider Thumbnail
...
function my_post_type_portfolio() {
	register_post_type( 'portfolio',
		array( 
				'label'             => __('Our Gallery', CURRENT_THEME),
...
/* Services */
function my_post_type_articles() {
	register_post_type( 'articles',
		array( 
				'label'             => __('Articles', CURRENT_THEME),
				'public'            => true, 
				'show_ui'           => true,
				'show_in_nav_menus' => false,
				'menu_position'     => 5,
...
add_action('init', 'my_post_type_articles');
